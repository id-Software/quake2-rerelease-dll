...
*/
	{
		...
		/* pickup_name_definite */ SNIPER_AMMO_NAME,
		/* quantity */ 10,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_AMMO,
...
*/
	{
		...
		/* icon */ "p_silencer",
		/* use_name */  SIL_NAME,
		/* pickup_name */  SIL_NAME,
		/* pickup_name_definite */ SIL_NAME,
		/* quantity */ 1,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_POWERUP,
...
*/
	{
		...
		/* icon */ "slippers",
		/* use_name */  SLIP_NAME,
		/* pickup_name */  SLIP_NAME,
		/* pickup_name_definite */ SLIP_NAME,
		/* quantity */ 1,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_POWERUP,
...
*/
	{
		...
		/* icon */ "i_jacketarmor",
		/* use_name */  KEV_NAME,
		/* pickup_name */  KEV_NAME,
		/* pickup_name_definite */ KEV_NAME,
		/* quantity */ 1,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_POWERUP,
